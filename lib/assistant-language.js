...
function healthEligibilityDeferralLine(language) {
  const l = normalizeAssistantLanguage(language);
  if (l === "Spanish") {
    return "La elegibilidad por salud depende de tu situación y de la aseguradora. No puedo confirmar cobertura para condiciones específicas — comunícate con Julie al 402-588-1125 (teléfono o texto), por WhatsApp al 402-440-5438, o escribe a Julie@mejorvidainsurance.com para una revisión personalizada.";
  }
  return "Health eligibility depends on your specific situation and the carrier. I'm not able to confirm coverage for specific conditions — please speak with Julie directly at 402-588-1125 (phone or text), on WhatsApp at 402-440-5438, or email Julie@mejorvidainsurance.com for a personalized review.";
}
