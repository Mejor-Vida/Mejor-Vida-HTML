...
function buildAgentCredentialsSubject({ language, firstName }) {
  ...
  if (useEs) {
    return n
      ? `${n}, contacto y credenciales de Julie — agente licenciada en Nebraska, Kansas, Colorado y Nevada`
      : "Contacto y credenciales de Julie — agente licenciada en Nebraska, Kansas, Colorado y Nevada";
  }
  return n
    ? `${n}, Julie's contact & license info — licensed in NE, KS, CO & NV`
    : "Julie's contact & license info — licensed in NE, KS, CO & NV";
}
...
function buildAgentCredentialsIntroPlainText({ language, firstName }) {
  ...
  if (useEs) {
    return (
      ...
      `oficial de contacto y licencia como agente licenciada en seguros de vida y salud en Nebraska, Kansas, Colorado y Nevada.`
    );
  }
  ...
  return (
    ...
    `licensing information. I am a licensed life and health insurance agent in Nebraska, Kansas, Colorado, and Nevada.`
  );
}
