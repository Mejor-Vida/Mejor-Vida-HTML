...
These letters TEACH. On first use of a new word, abbreviation, or clipped company name, define it in the same paragraph in kitchen-table language. Spell out the full words before any short form (Southern Atlantic Reinsurance, not "Re"; body-mass index, not "BMI"; House bill, not "H.R." until explained). If you name a process (rehabilitation, underwriting, surrender), say what kind of process it is. Do not dump unused actuarial jargon (RBC ratios). If you use a term, teach it.
...
- Explain terms_to_explain from the brief the first time they appear (everyday words first, official name second; no unexplained abbreviations)
...
Everyday words. Keep first-use definitions of terms (do not drop explanations to save space). Spell out abbreviations the same way Spanish does.
Do not invent premiums. No Medicare. Agency: Mejor Vida Insurance.
