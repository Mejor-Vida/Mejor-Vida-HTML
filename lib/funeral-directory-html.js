...
const US_STATES = [
  ...
  ["MI", "Míchigan", "Michigan"],
  ["MN", "Minnesota", "Minnesota"],
  ["MS", "Misisipi", "Mississippi"],
  ["MO", "Misuri", "Missouri"],
  ["MT", "Montana", "Montana"],
  ["NE", "Nebraska", "Nebraska"],
  ["NV", "Nevada", "Nevada"],
  ["NH", "Nuevo Hampshire", "New Hampshire"],
  ["NJ", "Nueva Jersey", "New Jersey"],
  ["NM", "Nuevo México", "New Mexico"],
  ["NY", "Nueva York", "New York"],
  ["NC", "Carolina del Norte", "North Carolina"],
  ["ND", "Dakota del Norte", "North Dakota"],
  ["OH", "Ohio", "Ohio"],
  ...
  ["SD", "Dakota del Sur", "South Dakota"],
  ...
  ["WV", "Virginia Occidental", "West Virginia"],
  ["WI", "Wisconsin", "Wisconsin"],
  ["WY", "Wyoming", "Wyoming"],
  ["DC", "Distrito de Columbia", "District of Columbia"],
];
...
function copy(isEn) {
  if (isEn) {
    return {
      ...
      heroLead:
        "Search funeral homes, contact information, and published general price lists in your area.",
  ...
  return {
    ...
    heroLead:
      "Busque funerarias, información de contacto y listas generales de precios publicadas en su área.",
...
function stateSelectHtml(isEn, selectedCode, selectId) {
  const t = copy(isEn);
  const opts = US_STATES.map(([code, es, en]) => {
    const label = isEn ? en : es;
