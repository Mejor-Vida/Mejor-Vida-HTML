 ...
 * Matches events in js/mvi-ga4-funnel.js and gastos-finales-ads-v3/js/landing-flow.js
 */
...
const LANDING_QUOTE_PATH = [
  {
    ...
    stepName: "landing_contact",
    description: "Facebook landing contact form viewed",
  },
  {
    id: "contact_submit",
    label: "Contact submit",
    eventName: "contact_submit_clicked",
    description: "User clicked continue on the contact form",
  },
  {
    id: "contact_lead",
    label: "Lead saved",
    eventName: "contact_lead_saved",
    description: "Name, phone, and opt-in saved",
  },
  {
    id: "quote_started",
    label: "Quote started",
    ...
    description: "User continued from the contact form into quote questions",
  },
  {
    id: "state",
    label: "State",
  ...
  },
  {
    ...
    paramFilter: { form_source: "landing_quote_early" },
    description: "Landing contact saved — callable lead",
  },
];
...
const LANDING_CALCULATOR_PATH = [
  {
    ...
    description: "User opened the calculator from quote results",
  },
  {
    id: "calc_state",
...
const LANDING_SCHEDULE_PATH = [
  {
    ...
    description: "User chose Schedule a call from quote or calculator results",
  },
  {
...
/** Licenses popup — GA4 side path, not sequential in the quote funnel. */
const LANDING_LICENSES_PATH = [
  {
    id: "licenses_opened",
    label: "Licenses opened",
    eventName: "licenses_opened",
    description: "User opened the licenses popup on the ads landing",
  },
  {
    id: "license_state_viewed",
    label: "State license click",
    eventName: "license_state_viewed",
    description: "User opened a specific state license from the popup",
  },
];
...
const LANDING_PATH_CONFIG = {
  ...
  licenses: LANDING_LICENSES_PATH,
};
