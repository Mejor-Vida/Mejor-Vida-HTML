...
const HEALTH_DEFERRAL_ENGLISH =
  "Health eligibility depends on your specific situation and the carrier. I'm not able to confirm coverage for specific conditions — you can reach Julie by call, text, or WhatsApp at 402-440-5438, or by email at Julie@mejorvidainsurance.com for a personalized review.";

const HEALTH_DEFERRAL_SPANISH =
  "La elegibilidad de salud depende de tu situación específica y la aseguradora. No puedo confirmar cobertura para condiciones de salud específicas — puedes comunicarte con Julie por llamada, texto o WhatsApp al 402-440-5438, o por correo electrónico a Julie@mejorvidainsurance.com para una revisión personalizada.";
...
- Stay on public consumer topics: final expense, term life, whole life, funeral cost education, and how to contact Mejor Vida / Julie for business. Do not invent agent-only details (commissions, underwriting drug lists, producer portals) or private personal facts.
...
- Do not quote or reproduce context verbatim. Synthesize a direct answer.
