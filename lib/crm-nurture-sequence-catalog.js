  ...
  pushStep(steps, {
    ...
    preview: {
      ...
      html: [
        ...
        "<h3>New leads — call tasks today (2)</h3>",
        "<ul>",
        "<li>Attempt #1 — due 9:00 AM</li>",
        "<li>Attempt #2 — due 5:00 PM</li>",
        "</ul>",
...
function buildNewsletterStep(settings, steps) {
  ...
  pushStep(steps, {
    phase: "newsletter",
    phase_label: "Weekly newsletter (all stages except unsubscribed)",
    day: null,
    when: `${dow} — ${hour}:00 Chicago time`,
    channel: "newsletter",
    channel_label: channelLabel("newsletter"),
    audience: "Lead (with email)",
    preview: {
      description:
        "Content imported via webhook or CRM. Hero + body in Spanish. All stages except Unsubscribed / Do not contact.",
      language: "spanish",
    },
    recurring: true,
  });
