...
function buildDailySummaryStep(settings, steps) {
  ...
  pushStep(steps, {
    ...
    note:
      `Internal morning digest sent to ${recipientLabel} — not sent to leads. Lists today's New-stage nurture call tasks plus a count of client emails/SMS scheduled for the day. Separate from the existing new-lead Gmail notification to julie@ and admin@ with the IntegrityCONNECT CSV attachment at intake.`,
  });
}
