...
<p>Homes shown are ones that publish a general price list or package list online. This is not every funeral home in the area, not a ranking, and not a claim that these are the lowest prices available. Figures are copied from each home’s published list as of the source dates above. Packages with the same name do not include the same items. Cemetery property, opening and closing, vaults, markers, cash-advance items, taxes, and extra certificates are not included unless a cell says so. Prices change. The funeral home’s current general price list is the only official price; the FTC Funeral Rule lets you ask that home for it. The estimator column is a third-party state average, not that home’s quote. We do not warrant that these figures are complete, current, or error-free. Mejor Vida does not set these prices and is not responsible for those businesses’ goods or services.</p>
</aside>`;
}

function funeralDirectoryCompareNote(lang) {
  if (lang === "es") {
    return `<aside class="sc-compare-legal" role="note">
<p><strong>Aviso de comparación.</strong> Esta lista es un directorio de contactos y de precios publicados. No es una cotización, no es una oferta de bienes o servicios funerarios, y no es un funeral prepagado. Mejor Vida Seguros LLC es una agencia de seguros independiente. No está afiliada, ni es propiedad, ni está respaldada por las funerarias o cementerios nombrados, y ellos no respaldan a Mejor Vida. Si se emite una póliza de gastos finales, paga efectivo a un beneficiario; puede usarlo en la funeraria que elija.</p>
<p>Las casas que aparecen son las reunidas al armar cada guía de ciudad, casi siempre porque publican una lista general de precios o paquetes. No son todas las funerarias del área, no es un ranking y no afirmamos que sean los precios más bajos. Las cifras se copian de la lista publicada de cada casa, con las fechas de la línea de fuentes. Un mismo nombre de paquete no incluye lo mismo. Propiedad en cementerio, apertura y cierre, bóveda, lápida, anticipos de efectivo, impuestos y certificados extra no van incluidos salvo que la nota lo diga. Los precios cambian. La lista general de precios vigente de la funeraria es el único precio oficial; la Regla Funeraria de la FTC le permite pedirla. Si una casa no publica una lista general de precios, el número que aparece es un promedio estatal de un tercero, no el precio de esa casa, y va marcado. No garantizamos que las cifras estén completas, vigentes o libres de error. Mejor Vida no fija estos precios y no responde por los bienes o servicios de esas empresas.</p>
</aside>`;
  }
  return `<aside class="sc-compare-legal" role="note">
<p><strong>Comparison notice.</strong> This list is a directory of contacts and published prices. It is not a quote, not an offer to sell funeral goods or services, and not a prepaid funeral. Mejor Vida Insurance LLC is an independent insurance agency. We are not affiliated with, owned by, or endorsed by the funeral homes or cemeteries named here, and they do not endorse Mejor Vida. If a final expense policy is issued, it pays cash to a beneficiary; they may use it at any funeral home they choose.</p>
<p>Homes shown are ones gathered while building each city guide, usually because they publish a general price list or package list. This is not every funeral home in the area, not a ranking, and not a claim that these are the lowest prices available. Figures are copied from each home’s published list as of the source dates. Packages with the same name do not include the same items. Cemetery property, opening and closing, vaults, markers, cash-advance items, taxes, and extra certificates are not included unless a note says so. Prices change. The funeral home’s current general price list is the only official price; the FTC Funeral Rule lets you ask that home for it. If a home does not publish a general price list, the number shown is a third-party state average, not that home’s price, and it is labeled. We do not warrant that these figures are complete, current, or error-free. Mejor Vida does not set these prices and is not responsible for those businesses’ goods or services.</p>
</aside>`;
}
