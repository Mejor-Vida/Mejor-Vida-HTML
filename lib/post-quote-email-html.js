...
<!-- Row 1: logo top-left on white (align= + inline styles for Outlook/Gmail) -->
<table role="presentation" align="left" width="100%" cellpadding="0" cellspacing="0" style="background:#ffffff;border-collapse:collapse;border-bottom:1px solid #e5e7eb;margin:0;">
<tr>
<td align="left" style="padding:18px 20px 16px;text-align:left !important;vertical-align:top;">
<a href="https://www.mejorvidainsurance.com" style="display:inline-block;text-align:left;text-decoration:none;margin:0;padding:0;">
<img src="${logoUrl}" alt="Mejor Vida Insurance" align="left" width="${LOGO_MAX_WIDTH_PX}" border="0" style="max-width:${LOGO_MAX_WIDTH_PX}px;width:${LOGO_MAX_WIDTH_PX}px;height:auto;display:block;margin:0;padding:0;border:0;outline:none;line-height:0;text-align:left;" />
</a>
</td>
</tr>
</table>
