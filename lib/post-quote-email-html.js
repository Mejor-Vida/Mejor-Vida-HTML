...
/** Logo in header (top right) — a bit smaller than full width. */
...
<tr>
<td style="padding:14px 12px 14px 20px;vertical-align:middle;text-align:left;">
<p style="margin:0;color:#fff;font-size:18px;font-weight:bold;line-height:1.3;">Mejor Vida Insurance</p>
<p style="margin:6px 0 0;color:#a8c4e0;font-size:13px;line-height:1.4;">Seguros Para Una Vida Mejor</p>
</td>
<td style="padding:12px 20px 12px 8px;vertical-align:top;text-align:right;width:1px;">
<img src="${logoUrl}" alt="" width="${LOGO_MAX_WIDTH_PX}" style="max-width:${LOGO_MAX_WIDTH_PX}px;width:100%;height:auto;display:block;margin-left:auto;" />
</td>
</tr>
</table>
