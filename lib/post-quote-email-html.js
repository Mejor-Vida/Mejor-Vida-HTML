...
<!-- Row 1: logo top-left on white (remote images may be blocked until user allows) -->
<table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background:#ffffff;border-collapse:collapse;border-bottom:1px solid #e5e7eb;">
<tr>
<td style="padding:18px 20px 16px;text-align:left;vertical-align:top;">
<a href="https://www.mejorvidainsurance.com" style="text-decoration:none;">
<img src="${logoUrl}" alt="Mejor Vida Insurance" width="${LOGO_MAX_WIDTH_PX}" border="0" style="max-width:${LOGO_MAX_WIDTH_PX}px;width:${LOGO_MAX_WIDTH_PX}px;height:auto;display:block;border:0;outline:none;line-height:0;" />
</a>
</td>
</tr>
</table>
<!-- Row 2: blue title strip below logo -->
<table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background:#1e3a8a;border-collapse:collapse;">
<tr>
<td style="padding:18px 20px 20px;text-align:left;vertical-align:middle;">
