...
/** Logo was 180px max; 3× for visibility on white header. */
const LOGO_MAX_WIDTH_PX = 540;
...
.h{background:#fff;padding:12px 20px 14px;text-align:center;border-bottom:1px solid #e5e7eb;}
.h img{max-width:${LOGO_MAX_WIDTH_PX}px;width:100%;height:auto;margin:0 auto 8px;display:block;}
.ht{color:#1e3a8a;font-size:18px;font-weight:bold;margin:0;}
.hs{color:#475569;font-size:13px;margin:6px 0 0;}
...
<div class="h"><img src="${logoUrl}" alt="Mejor Vida Insurance" /><p class="ht">Mejor Vida Insurance</p><p class="hs">Seguros Para Una Vida Mejor</p></div>
