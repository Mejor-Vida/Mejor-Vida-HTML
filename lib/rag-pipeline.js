...
function isAssurityFinalExpenseQuestion(question) {
  ...
  return (
    /\b(final expense|gastos finales|funeral|protect\+|perform\+)\b/.test(t) ||
    (/\b(whole life|vida entera|productos?|products?)\b/.test(t) &&
      /\b(offer|ofrece|tiene|have|use|usa|for|para)\b/.test(t))
  );
}
