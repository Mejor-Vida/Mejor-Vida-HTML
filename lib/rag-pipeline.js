...
/** Do not cache FAQs for contact/location/bio questions — avoids stale bio beating dedicated chunks. */
function shouldSkipFaqCaching(q) {
  const t = String(q || "").toLowerCase();
  return /tel[eé]fono|phone|n[uú]mero|number|contact|contacto|reach|ubicad|located|address|direcci[oó]n|who is julie|qui[eé]n es julie/i.test(
    t,
  );
}
