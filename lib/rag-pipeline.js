...
function applyKnowledgeAnswerPostProcess(question, answerText, isSpanishQuery, skipFaqHealth) {
  ...
  if (isContactPhoneQuestion(question) && out) {
    ...
    if (!hasAllThree) {
      out +=
        isSpanishQuery
          ? ' También guarda el 402-207-8568 como línea de oficina de Mejor Vida Insurance y el 402-440-5438 como línea directa de Julie. El +1 (402) 735-5665 es para mensajes de texto automáticos.'
          : ' Also save 402-207-8568 as the Mejor Vida Insurance office line and 402-440-5438 as Julie\'s direct line. +1 (402) 735-5665 is for automated text updates.';
    }
  }
  return out;
}
