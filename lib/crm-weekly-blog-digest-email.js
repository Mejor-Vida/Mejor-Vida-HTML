 ...
 * Short story teasers + small images + links to full website articles.
 */
    ...
    stories: [
      {
        ...
        article_url: `${SITE}/blog/unum-reaseguro-ltc-2026-07-06.html`,
      },
      {
        ...
        article_url: `${SITE}/blog/aumentos-primas-medigap-2026-07-08.html`,
      },
      {
        ...
        article_url: `${SITE}/blog/liquidaciones-vida-naifa-2026-07-11.html`,
      },
    ],
  };
}
...
<p style="margin:0;text-align:center;">
  <a href="${url}" style="display:inline-block;padding:10px 18px;border-radius:6px;font-weight:bold;font-size:14px;text-decoration:none;background:#1a56db;color:#ffffff;">Leer el artículo completo</a>
</p>
</div>`;
}
