#!/usr/bin/env node
/**
 * Find first-party GPL / pricing pages on funeral-home websites.
 * Does not invent prices. Writes a report to data/{state}-gpl-probe.json.
 *
 * Usage: node scripts/funeral-directory/probe-gpls.js kansas|nebraska|colorado|nevada
 */
const fs = require("fs");
...
async function main() {
  ...
  console.log(`probing ${homes.length} unique ${STATE} sites`);
