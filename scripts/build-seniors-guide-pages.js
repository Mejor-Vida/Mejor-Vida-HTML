...
const PAGES = {
  ...
  prepaidFuneral: {
    esFile: "funerales-prepagados.html",
    enFile: "prepaid-funerals.html",
    hero: {
      base: "fep-hero-centennial-bridge",
      modifier: "bridge",
      width: 1024,
      height: 682,
      cache: "20260903-prepaid",
    },
  },
  payFuneral: {
    esFile: "como-pagar-un-funeral.html",
    enFile: "how-to-pay-for-a-funeral.html",
    hero: {
      base: "fep-hero-bus-stop-couple",
      modifier: "couple",
      width: 1024,
      height: 682,
      cache: "20260903-pay",
  ...
  estatePlanning: {
    esFile: "planificacion-patrimonial.html",
    enFile: "estate-planning.html",
    hero: {
      base: "lic-hero-family-tuscany",
      modifier: "estate",
      width: 1024,
      height: 523,
      cache: "20260904-estate",
    },
  },
  condHub: {
                    ...
                    : kind === "grandchildren"
                      ...
                      : kind === "familyHub" ||
                        ...
                        : kind === "feProduct"
                          ...
                          : kind === "estatePlanning"
                            ? "lic-page lic-page--seniors lic-page--estate"
                          : kind === "condHub" ||
                            kind === "condTerm" ||
                            kind === "diabetes" ||
                            kind === "heart" ||
...
<link href="${prefix}css/quote-flow-shared.css?v=20260905-gift" rel="stylesheet"/>
...
<link href="${prefix}css/life-insurance-cost.css?v=20260905-estate" rel="stylesheet"/>
...
function examRateScripts(lang, kind) {
  ...
  if (kind === "findPolicy" || kind === "funeralCost" || kind === "prepaidFuneral" || kind === "payFuneral" || kind === "planFuneral" || kind === "estatePlanning") return "";
  if (kind === "feProduct") {
...
function copyFor(kind, lang) {
  ...
  if (kind === "estatePlanning") return copyEstate(lang);
...
function mainFor(kind, lang, page, c) {
  ...
  if (kind === "estatePlanning") return estateMain(lang, page, c);
