...
const lasVegas = makeCity({
  ...
  nameEs: "Las Vegas",
  nameEn: "Las Vegas",
  heroFile: "las-vegas-welcome-sign",
  heroCaptionEs: "Letrero Welcome to Fabulous Las Vegas",
  heroCaptionEn: "Welcome to Fabulous Las Vegas sign",
  heroClass: "sc-hero--las-vegas",
  heroW: 1350,
  heroH: 900,
...
const henderson = estimatorCity({
  ...
  nameEs: "Henderson",
  nameEn: "Henderson",
  heroFile: "henderson-water-street",
  heroCaptionEs: "Water Street, Henderson",
  heroCaptionEn: "Water Street, Henderson",
  heroClass: "sc-hero--henderson",
  heroW: 1200,
  heroH: 900,
...
const reno = makeCity({
  ...
  nameEn: "Reno",
  heroFile: "reno-arch",
  heroCaptionEs: "Arco de Reno",
  heroCaptionEn: "Reno Arch",
  heroClass: "sc-hero--reno",
  heroW: 1200,
  heroH: 900,
...
const sparks = makeCity({
  ...
  nameEs: "Sparks",
  nameEn: "Sparks",
  heroFile: "sparks-victorian-square",
  heroCaptionEs: "Victorian Square, Sparks",
  heroCaptionEn: "Victorian Square, Sparks",
  heroClass: "sc-hero--sparks",
  heroW: 1200,
  heroH: 900,
...
const carsonCity = makeCity({
  ...
  nameEs: "Carson City",
  nameEn: "Carson City",
  heroFile: "carson-city-capitol",
  heroCaptionEs: "Capitolio de Nevada, Carson City",
  heroCaptionEn: "Nevada State Capitol, Carson City",
  heroClass: "sc-hero--carson-city",
  heroW: 1216,
  heroH: 900,
