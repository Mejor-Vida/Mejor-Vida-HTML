...
<script defer src="js/mvi-nav-questions.js?v=20260819-seniors85"></script>
...
function copy(lang) {
  ...
  if (isEs) {
    return {
      ...
      other3: "<strong>Patrimonio y familia</strong> — herencias o ayuda de hijos. El <a href=\"final-expense-estimator.html\">estimador de gastos finales</a> y la <a href=\"blog/cuanto-cuesta-seguro-gastos-finales.html\">guía de costos funerarios</a> ayudan a dimensionar el hueco. También: <a href=\"blog/medicare-paga-gastos-finales.html\">qué paga Medicare</a> y <a href=\"guias-gastos-finales.html\">cómo planificar</a>.",
  ...
  return {
    ...
    other3: "<strong>Estate and family</strong> — inheritances or help from adult children. The <a href=\"final-expense-estimator.html\">final expense estimator</a> and the <a href=\"../blog/cuanto-cuesta-seguro-gastos-finales.html\">funeral cost guide</a> help size the gap. Also: <a href=\"../blog/medicare-paga-gastos-finales.html\">what Medicare pays</a> and <a href=\"../guias-gastos-finales.html\">how to plan</a>.",
