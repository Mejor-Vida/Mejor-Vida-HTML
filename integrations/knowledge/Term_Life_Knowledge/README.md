...
- Colorado Standard-tobacco stopped at 72 of 216 cells in an earlier logout; re-run picks up where it left off
...
- States: Nebraska, Kansas, Colorado, and Nevada harvested. Rates came back identical across matching cells, so these carriers appear to price these products uniformly here
