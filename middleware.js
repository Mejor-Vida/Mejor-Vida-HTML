...
function buildContentSecurityPolicy(nonce) {
  ...
  return [
    ...
    `connect-src 'self' https://*.supabase.co wss://*.supabase.co https://www.facebook.com https://facebook.com https://connect.facebook.net https://*.facebook.com https://*.facebook.net https://www.google-analytics.com https://*.google-analytics.com https://analytics.google.com https://*.analytics.google.com https://www.googletagmanager.com https://web.push.apple.com https://*.push.apple.com https://fcm.googleapis.com https://android.googleapis.com https://updates.push.services.mozilla.com`,
    "worker-src 'self'",
    "manifest-src 'self'",
